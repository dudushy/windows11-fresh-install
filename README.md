...
- Install the applications you need via Winget with this awesome [site](https://winget.run/)
  ...
  ```txt
  winget install Spotify.Spotify Discord.Discord Brave.Brave Bitwarden.Bitwarden VideoLAN.VLC WinSCP.WinSCP Famatech.AdvancedIPScanner RaspberryPiFoundation.RaspberryPiImager SublimeHQ.SublimeText.4 GitExtensionsTeam.GitExtensions CPUID.CPU-Z RARLab.WinRAR Valve.Steam Klocman.BulkCrapUninstaller qBittorrent.qBittorrent AnyDesk.AnyDesk Microsoft.PowerShell Microsoft.PowerToys Microsoft.WindowsTerminal Microsoft.VisualStudioCode Notion.Notion Google.GoogleDrive Git.Git  DBeaver.DBeaver.Community --source winget --exact --silent --accept-package-agreements --accept-source-agreements --disable-interactivity --no-upgrade
  ```
